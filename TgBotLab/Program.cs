...
namespace TgBotLab
{
    internal class Program
    {
        ...
        {
            var client = new TelegramBotClient("6322360795:AAHo-nzFcY_n88E1ipKdUME3UNWx7E_526c");
        ...
        private static async Task Update(ITelegramBotClient botClient, Update update, CancellationToken token)
        {
            ...
            if (message != null)
            {
                ...
                {
                    await botClient.SendTextMessageAsync(message.Chat.Id, "вулиця Степана Бандери, 12, Львів, Львівська область, 79000");
                    Message messagePhoto = await botClient.SendPhotoAsync(
                        chatId: message.Chat.Id,
                        photo: InputFile.FromUri("https://lpnu.ua/sites/default/files/2022/8/2/news/20560/img1425n.jpg"),
